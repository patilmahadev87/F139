...
public class Applicant {
	...
	private Disburtment disburse;
	@OneToOne(cascade = CascadeType.ALL)
	private LoanSanction loanSanction;
	
	public Disburtment getDisburse() {
		return disburse;
	}

	public void setDisburse(Disburtment disburse) {
		this.disburse = disburse;
	}

	public LoanSanction getLoanSanction() {
		return loanSanction;
	}

	public void setLoanSanction(LoanSanction loanSanction) {
		this.loanSanction = loanSanction;
	}
